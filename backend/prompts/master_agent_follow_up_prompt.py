...
Based on the conversation history and the last user input, determine what information is still missing or needs clarification. Ask a natural language question or statement to the user to gather more information.
...
Your response MUST be a raw JSON object with:
- 'status': "continue", "complete", or "invalid_input"
- 'message': a natural language string to the user
- 'data': the current JSON object of collected inputs
...
- The JSON examples below use standard curly braces {{ }} for valid JSON.
